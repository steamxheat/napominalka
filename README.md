...
Бот-напоминалка на Python с бесплатным локальным распознаванием голоса через Vosk.

## Возможности

- текстовые напоминания;
- голосовые напоминания через бесплатный офлайн Vosk;
...
При первом голосовом сообщении бот сам скачает бесплатную русскую модель Vosk в `models/`.
